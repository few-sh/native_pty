...
void main() async {
  ...
  final pty1 = NativePty.spawn(
    ...
    [
      '/bin/bash',
      '-c',
      'read -p "Enter text (canonical): " input && echo "You entered: \$input"'
    ],
  ...
  final pty2 = NativePty.spawn(
    ...
    [
      '/bin/bash',
      '-c',
      'echo "Press any key..."; read -n 1 key && echo "\nYou pressed a key!"'
    ],
