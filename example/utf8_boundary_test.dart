...
void main() async {
  ...
  try {
    ...
    print(
        'Test complete message received: ${hasTestComplete ? "✓ YES" : "✗ NO"}');
    ...
    if (hasEmoji && hasTestComplete && aCount == 4090) {
      ...
      print(
          'The stateful Utf8Decoder correctly handled split multi-byte characters.');
    } else {
      ...
      if (aCount != 4090) {
        print('  - Character count mismatch (got $aCount, expected 4090)');
      }
    }
    ...
    print('Failed to spawn helper program: $e');
